  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-md px-6 py-24">
      ...
      <form onSubmit={onSubmit} className="space-y-4 rounded-xl border border-accent/30 bg-white/60 p-6 shadow-[0_0_0_1px_rgba(192,160,98,0.15)] backdrop-blur-sm dark:bg-gray-900/60">
        <div>
          <label className="mb-2 block text-sm text-gray-600 dark:text-gray-400">Full name</label>
          <input
            type="text"
            value={name}
        ...
        <button type="submit" className="w-full rounded-lg border border-accent/40 px-4 py-2 text-sm text-accent transition-colors hover:border-accent hover:bg-accent hover:text-white">Create account</button>
